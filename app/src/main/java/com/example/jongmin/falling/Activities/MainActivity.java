package com.example.jongmin.falling.Activities;
...
//        LinearLayout relativeLayout = (RelativeLayout)inflater.inflate(R.layout.overlay, null);
//        RelativeLayout.LayoutParams paramlinear = new RelativeLayout.LayoutParams(
//                RelativeLayout.LayoutParams.MATCH_PARENT,
//                RelativeLayout.LayoutParams.MATCH_PARENT
//        );
//        addContentView(relativeLayout, paramlinear);

        mView= (MyGLSurfaceView) findViewById(R.id.boardView);
                    ...
                    while (!isInterrupted()) {
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                mTextView.setText(Long.toString((System.currentTimeMillis() - GameEnv.starttime)/1000));
